...
export function handDrawnCircle(pos, r, noiseMult = 0.05, noiseScale = 1.0, steps = 8, zStep = 0.0) {
    ...
    return new Polygon(chaikinCurve(asPoints(center(new Polygon(linspace(startTheta, startTheta + 2.0 * Math.PI, steps, false).map((theta) => {
