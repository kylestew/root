 ...
 */
export function pickRandom(arr: any[], num: number = 1) {
    if (arr.length === 0) {
 ...
 */
export function randomOffset(maxX: number, maxY: number) {
    if (arguments.length === 1) {
        maxY = maxX
    }
 ...
 */
export function weightedRandom(targetArray: any[], weights: any[]) {
 ...
 */
export function pareto(xm: number, alpha: number) {
